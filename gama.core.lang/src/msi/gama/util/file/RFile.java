...
public class RFile<C extends IAddressableContainer & IModifiableContainer, C1> extends GamaFile<IMap, Object> {
	...
	@doc(value = "This file constructor allows to read a R file", examples = {
	...
	@doc(value = "This file constructor allows to store a map in a R file (it does not save it - just store it in memory)", examples = {
